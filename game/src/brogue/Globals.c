...
{
    return (
        tileCatalog[pmapAt(p)->layers[DUNGEON]].flags | tileCatalog[pmapAt(p)->layers[LIQUID]].flags | tileCatalog[pmapAt(p)->layers[SURFACE]].flags | tileCatalog[pmapAt(p)->layers[GAS]].flags);
}

unsigned long terrainMechFlags(pos loc)
{
    return (
        tileCatalog[pmapAt(loc)->layers[DUNGEON]].mechFlags | tileCatalog[pmapAt(loc)->layers[LIQUID]].mechFlags | tileCatalog[pmapAt(loc)->layers[SURFACE]].mechFlags | tileCatalog[pmapAt(loc)->layers[GAS]].mechFlags);
}
...
creatureType monsterCatalog[NUMBER_MONSTER_KINDS] = {
    ...
    {0, "you", G_PLAYER, &playerInLightColor, 30, 0, 100, {1, 2, 1}, 20, 100, 100, DF_RED_BLOOD, 0, false, 0, 0, {0}, (MONST_MALE | MONST_FEMALE)},
    ...
    {0, "eel", G_EEL, &eelColor, 18, 27, 100, {3, 7, 2}, 5, 50, 100, 0, 0, false, 0, 0, {0}, (MONST_RESTRICTED_TO_LIQUID | MONST_IMMUNE_TO_WATER | MONST_SUBMERGES | MONST_FLITS | MONST_NEVER_SLEEPS)},
    {0, "monkey", G_MONKEY, &ogreColor, 12, 17, 100, {1, 3, 1}, 20, 100, 100, DF_RED_BLOOD, 0, false, 1, DF_URINE, {0}, (0), (MA_HIT_STEAL_FLEE)},
    {0, "bloat", G_BLOAT, &poisonGasColor, 4, 0, 100, {0, 0, 0}, 5, 100, 100, DF_PURPLE_BLOOD, 0, false, 0, DF_BLOAT_DEATH, {0}, (MONST_FLIES | MONST_FLITS), (MA_KAMIKAZE | MA_DF_ON_DEATH)},
    {0, "pit bloat", G_BLOAT, &lightBlue, 4, 0, 100, {0, 0, 0}, 5, 100, 100, DF_PURPLE_BLOOD, 0, false, 0, DF_HOLE_POTION, {0}, (MONST_FLIES | MONST_FLITS), (MA_KAMIKAZE | MA_DF_ON_DEATH)},
    {0, "goblin", G_GOBLIN, &goblinColor, 15, 10, 70, {2, 5, 1}, 20, 100, 100, DF_RED_BLOOD, 0, false, 0, 0, {0}, (0), (MA_ATTACKS_PENETRATE | MA_AVOID_CORRIDORS)},
    {0, "goblin conjurer", G_GOBLIN_MAGIC, &goblinConjurerColor, 10, 10, 70, {2, 4, 1}, 20, 100, 100, DF_RED_BLOOD, 0, false, 0, 0, {0}, (MONST_MAINTAINS_DISTANCE | MONST_CAST_SPELLS_SLOWLY | MONST_CARRY_ITEM_25), (MA_CAST_SUMMON | MA_AVOID_CORRIDORS)},
    {0, "goblin mystic", G_GOBLIN_MAGIC, &goblinMysticColor, 10, 10, 70, {2, 4, 1}, 20, 100, 100, DF_RED_BLOOD, 0, false, 0, 0, {BOLT_SHIELDING}, (MONST_MAINTAINS_DISTANCE | MONST_CARRY_ITEM_25), (MA_AVOID_CORRIDORS)},
    {0, "goblin totem", G_TOTEM, &orange, 30, 0, 0, {0, 0, 0}, 0, 100, 300, DF_RUBBLE_BLOOD, IMP_LIGHT, false, 0, 0, {BOLT_HASTE, BOLT_SPARK}, (MONST_IMMUNE_TO_WEBS | MONST_NEVER_SLEEPS | MONST_IMMOBILE | MONST_INANIMATE | MONST_WILL_NOT_USE_STAIRS), (0)},
    {0, "pink jelly", G_JELLY, &pinkJellyColor, 50, 0, 85, {1, 3, 1}, 0, 100, 100, DF_PURPLE_BLOOD, 0, true, 0, 0, {0}, (MONST_NEVER_SLEEPS), (MA_CLONE_SELF_ON_DEFEND)},
    {0, "toad", G_TOAD, &toadColor, 18, 0, 90, {1, 4, 1}, 10, 100, 100, DF_GREEN_BLOOD, 0, false, 0, 0, {0}, (0), (MA_HIT_HALLUCINATE)},
    {0, "vampire bat", G_BAT, &gray, 18, 25, 100, {2, 6, 1}, 20, 50, 100, DF_RED_BLOOD, 0, false, 0, 0, {0}, (MONST_FLIES | MONST_FLITS), (MA_TRANSFERENCE)},
    {0, "arrow turret", G_TURRET, &black, 30, 0, 90, {2, 6, 1}, 0, 100, 250, 0, 0, false, 0, 0, {BOLT_DISTANCE_ATTACK}, (MONST_TURRET), (0)},
    {0, "acid mound", G_MOUND, &acidBackColor, 15, 10, 70, {1, 3, 1}, 5, 100, 100, DF_ACID_BLOOD, 0, false, 0, 0, {0}, (MONST_DEFEND_DEGRADE_WEAPON), (MA_HIT_DEGRADE_ARMOR)},
    {0, "centipede", G_CENTIPEDE, &centipedeColor, 20, 20, 80, {4, 12, 1}, 20, 100, 100, DF_GREEN_BLOOD, 0, false, 0, 0, {0}, (0), (MA_CAUSES_WEAKNESS)},
    {0, "ogre", G_OGRE, &ogreColor, 55, 60, 125, {9, 13, 2}, 20, 100, 200, DF_RED_BLOOD, 0, true, 0, 0, {0}, (MONST_MALE | MONST_FEMALE), (MA_AVOID_CORRIDORS | MA_ATTACKS_STAGGER)},
    {0, "bog monster", G_BOG_MONSTER, &krakenColor, 55, 60, 5000, {3, 4, 1}, 3, 200, 100, 0, 0, true, 0, 0, {0}, (MONST_RESTRICTED_TO_LIQUID | MONST_SUBMERGES | MONST_FLITS | MONST_FLEES_NEAR_DEATH), (MA_SEIZES)},
    {0, "ogre totem", G_TOTEM, &green, 70, 0, 0, {0, 0, 0}, 0, 100, 400, DF_RUBBLE_BLOOD, LICH_LIGHT, false, 0, 0, {BOLT_HEALING, BOLT_SLOW_2}, (MONST_IMMUNE_TO_WEBS | MONST_NEVER_SLEEPS | MONST_IMMOBILE | MONST_INANIMATE | MONST_WILL_NOT_USE_STAIRS), (0)},
    {0, "spider", G_SPIDER, &white, 20, 70, 90, {3, 4, 2}, 20, 100, 200, DF_GREEN_BLOOD, 0, false, 0, 0, {BOLT_SPIDERWEB}, (MONST_IMMUNE_TO_WEBS | MONST_CAST_SPELLS_SLOWLY | MONST_ALWAYS_USE_ABILITY), (MA_POISONS)},
    {0, "spark turret", G_TURRET, &lightningColor, 80, 0, 100, {0, 0, 0}, 0, 100, 150, 0, SPARK_TURRET_LIGHT, false, 0, 0, {BOLT_SPARK}, (MONST_TURRET), (0)},
    {0, "wisp", G_WISP, &wispLightColor, 10, 90, 100, {0, 0, 0}, 5, 100, 100, DF_ASH_BLOOD, WISP_LIGHT, false, 0, 0, {0}, (MONST_IMMUNE_TO_FIRE | MONST_FLIES | MONST_FLITS | MONST_NEVER_SLEEPS | MONST_FIERY | MONST_DIES_IF_NEGATED), (MA_HIT_BURN)},
    {0, "wraith", G_WRAITH, &wraithColor, 50, 60, 120, {6, 13, 2}, 5, 50, 100, DF_GREEN_BLOOD, 0, true, 0, 0, {0}, (MONST_FLEES_NEAR_DEATH)},
    {0, "zombie", G_ZOMBIE, &vomitColor, 80, 0, 120, {7, 12, 1}, 0, 100, 100, DF_ROT_GAS_BLOOD, 0, true, 100, DF_ROT_GAS_PUFF, {0}},
    {0, "troll", G_TROLL, &trollColor, 65, 70, 125, {10, 15, 3}, 1, 100, 100, DF_RED_BLOOD, 0, true, 0, 0, {0}, (MONST_MALE | MONST_FEMALE)},
    {0, "ogre shaman", G_OGRE_MAGIC, &green, 45, 40, 100, {5, 9, 1}, 20, 100, 200, DF_RED_BLOOD, 0, true, 0, 0, {BOLT_HASTE, BOLT_SPARK}, (MONST_MAINTAINS_DISTANCE | MONST_CAST_SPELLS_SLOWLY | MONST_MALE | MONST_FEMALE), (MA_CAST_SUMMON | MA_AVOID_CORRIDORS)},
    {0, "naga", G_NAGA, &trollColor, 75, 70, 150, {7, 11, 4}, 10, 100, 100, DF_GREEN_BLOOD, 0, true, 100, DF_PUDDLE, {0}, (MONST_IMMUNE_TO_WATER | MONST_SUBMERGES | MONST_NEVER_SLEEPS | MONST_FEMALE), (MA_ATTACKS_ALL_ADJACENT)},
    {0, "salamander", G_SALAMANDER, &salamanderColor, 60, 70, 150, {5, 11, 3}, 10, 100, 100, DF_ASH_BLOOD, SALAMANDER_LIGHT, true, 100, DF_SALAMANDER_FLAME, {0}, (MONST_IMMUNE_TO_FIRE | MONST_SUBMERGES | MONST_NEVER_SLEEPS | MONST_FIERY | MONST_MALE), (MA_ATTACKS_EXTEND)},
    {0, "explosive bloat", G_BLOAT, &orange, 10, 0, 100, {0, 0, 0}, 5, 100, 100, DF_RED_BLOOD, EXPLOSIVE_BLOAT_LIGHT, false, 0, DF_BLOAT_EXPLOSION, {0}, (MONST_FLIES | MONST_FLITS), (MA_KAMIKAZE | MA_DF_ON_DEATH)},
    {0, "dar blademaster", G_DAR_BLADEMASTER, &purple, 35, 70, 160, {5, 9, 2}, 20, 100, 100, DF_RED_BLOOD, 0, false, 0, 0, {BOLT_BLINKING}, (MONST_CARRY_ITEM_25 | MONST_MALE | MONST_FEMALE), (MA_AVOID_CORRIDORS)},
    {0, "dar priestess", G_DAR_PRIESTESS, &darPriestessColor, 20, 60, 100, {2, 5, 1}, 20, 100, 100, DF_RED_BLOOD, 0, false, 0, 0, {BOLT_NEGATION, BOLT_HEALING, BOLT_HASTE, BOLT_SPARK}, (MONST_MAINTAINS_DISTANCE | MONST_CARRY_ITEM_25 | MONST_FEMALE), (MA_AVOID_CORRIDORS)},
    {0, "dar battlemage", G_DAR_BATTLEMAGE, &darMageColor, 20, 60, 100, {1, 3, 1}, 20, 100, 100, DF_RED_BLOOD, 0, false, 0, 0, {BOLT_FIRE, BOLT_SLOW_2, BOLT_DISCORD}, (MONST_MAINTAINS_DISTANCE | MONST_CARRY_ITEM_25 | MONST_MALE | MONST_FEMALE), (MA_AVOID_CORRIDORS)},
    {0, "acidic jelly", G_JELLY, &acidBackColor, 60, 0, 115, {2, 6, 1}, 0, 100, 100, DF_ACID_BLOOD, 0, true, 0, 0, {0}, (MONST_DEFEND_DEGRADE_WEAPON), (MA_HIT_DEGRADE_ARMOR | MA_CLONE_SELF_ON_DEFEND)},
    {0, "centaur", G_CENTAUR, &tanColor, 35, 50, 175, {4, 8, 2}, 20, 50, 100, DF_RED_BLOOD, 0, true, 0, 0, {BOLT_DISTANCE_ATTACK}, (MONST_MAINTAINS_DISTANCE | MONST_MALE), (0)},
    {0, "underworm", G_UNDERWORM, &wormColor, 80, 40, 160, {18, 22, 2}, 3, 150, 200, DF_WORM_BLOOD, 0, true, 0, 0, {0}, (MONST_NEVER_SLEEPS)},
    {0, "sentinel", G_GUARDIAN, &sentinelColor, 50, 0, 0, {0, 0, 0}, 0, 100, 175, DF_RUBBLE_BLOOD, SENTINEL_LIGHT, false, 0, 0, {BOLT_HEALING, BOLT_SPARK}, (MONST_TURRET | MONST_CAST_SPELLS_SLOWLY | MONST_DIES_IF_NEGATED), (0)},
    {0, "dart turret", G_TURRET, &centipedeColor, 20, 0, 140, {1, 2, 1}, 0, 100, 250, 0, 0, false, 0, 0, {BOLT_POISON_DART}, (MONST_TURRET), (MA_CAUSES_WEAKNESS)},
    {0, "kraken", G_KRAKEN, &krakenColor, 120, 0, 150, {15, 20, 3}, 1, 50, 100, 0, 0, true, 0, 0, {0}, (MONST_RESTRICTED_TO_LIQUID | MONST_IMMUNE_TO_WATER | MONST_SUBMERGES | MONST_FLITS | MONST_NEVER_SLEEPS | MONST_FLEES_NEAR_DEATH), (MA_SEIZES)},
    {0, "lich", G_LICH, &white, 35, 80, 175, {2, 6, 1}, 0, 100, 100, DF_ASH_BLOOD, LICH_LIGHT, true, 0, 0, {BOLT_FIRE}, (MONST_MAINTAINS_DISTANCE | MONST_CARRY_ITEM_25 | MONST_NO_POLYMORPH), (MA_CAST_SUMMON)},
    {0, "phylactery", G_EGG, &lichLightColor, 30, 0, 0, {0, 0, 0}, 0, 100, 150, DF_RUBBLE_BLOOD, LICH_LIGHT, false, 0, 0, {0}, (MONST_IMMUNE_TO_WEBS | MONST_NEVER_SLEEPS | MONST_IMMOBILE | MONST_INANIMATE | MONST_ALWAYS_HUNTING | MONST_WILL_NOT_USE_STAIRS | MONST_DIES_IF_NEGATED), (MA_CAST_SUMMON | MA_ENTER_SUMMONS)},
    {0, "pixie", G_PIXIE, &pixieColor, 10, 90, 100, {1, 3, 1}, 20, 50, 100, DF_GREEN_BLOOD, PIXIE_LIGHT, false, 0, 0, {BOLT_NEGATION, BOLT_SLOW_2, BOLT_DISCORD, BOLT_SPARK}, (MONST_MAINTAINS_DISTANCE | MONST_FLIES | MONST_FLITS | MONST_MALE | MONST_FEMALE), (0)},
    {0, "phantom", G_PHANTOM, &ectoplasmColor, 35, 70, 160, {12, 18, 4}, 0, 50, 200, DF_ECTOPLASM_BLOOD, 0, true, 2, DF_ECTOPLASM_DROPLET, {0}, (MONST_INVISIBLE | MONST_FLITS | MONST_FLIES | MONST_IMMUNE_TO_WEBS)},
    {0, "flame turret", G_TURRET, &lavaForeColor, 40, 0, 150, {1, 2, 1}, 0, 100, 250, 0, LAVA_LIGHT, false, 0, 0, {BOLT_FIRE}, (MONST_TURRET), (0)},
    {0, "imp", G_IMP, &pink, 35, 90, 225, {4, 9, 2}, 10, 100, 100, DF_GREEN_BLOOD, IMP_LIGHT, false, 0, 0, {BOLT_BLINKING}, (0), (MA_HIT_STEAL_FLEE)},
    {0, "fury", G_FURY, &darkRed, 19, 90, 200, {6, 11, 4}, 20, 50, 100, DF_RED_BLOOD, 0, false, 0, 0, {0}, (MONST_NEVER_SLEEPS | MONST_FLIES)},
    {0, "revenant", G_REVENANT, &ectoplasmColor, 30, 0, 200, {15, 20, 5}, 0, 100, 100, DF_ECTOPLASM_BLOOD, 0, true, 0, 0, {0}, (MONST_IMMUNE_TO_WEAPONS)},
    {0, "tentacle horror", G_TENTACLE_HORROR, &centipedeColor, 120, 95, 225, {25, 35, 3}, 1, 100, 100, DF_PURPLE_BLOOD, 0, true, 0, 0, {0}},
    {0, "golem", G_GOLEM, &gray, 400, 70, 225, {4, 8, 1}, 0, 100, 100, DF_RUBBLE_BLOOD, 0, true, 0, 0, {0}, (MONST_REFLECT_50 | MONST_DIES_IF_NEGATED)},
    {0, "dragon", G_DRAGON, &dragonColor, 150, 90, 250, {25, 50, 4}, 20, 50, 200, DF_GREEN_BLOOD, 0, true, 0, 0, {BOLT_DRAGONFIRE}, (MONST_IMMUNE_TO_FIRE | MONST_CARRY_ITEM_100), (MA_ATTACKS_ALL_ADJACENT)},

    // bosses
    {0, "goblin warlord", G_GOBLIN_CHIEFTAN, &blue, 30, 17, 100, {3, 6, 1}, 20, 100, 100, DF_RED_BLOOD, 0, false, 0, 0, {0}, (MONST_MAINTAINS_DISTANCE | MONST_CARRY_ITEM_25), (MA_CAST_SUMMON | MA_ATTACKS_PENETRATE | MA_AVOID_CORRIDORS)},
    {0, "black jelly", G_JELLY, &black, 120, 0, 130, {3, 8, 1}, 0, 100, 100, DF_PURPLE_BLOOD, 0, true, 0, 0, {0}, (0), (MA_CLONE_SELF_ON_DEFEND)},
    {0, "vampire", G_VAMPIRE, &white, 75, 60, 120, {4, 15, 2}, 6, 50, 100, DF_RED_BLOOD, 0, true, 0, DF_BLOOD_EXPLOSION, {BOLT_BLINKING, BOLT_DISCORD}, (MONST_FLEES_NEAR_DEATH | MONST_MALE), (MA_TRANSFERENCE | MA_DF_ON_DEATH | MA_CAST_SUMMON | MA_ENTER_SUMMONS)},
    {0, "flamedancer", G_FLAMEDANCER, &white, 65, 80, 120, {3, 8, 2}, 0, 100, 100, DF_EMBER_BLOOD, FLAMEDANCER_LIGHT, true, 100, DF_FLAMEDANCER_CORONA, {BOLT_FIRE}, (MONST_MAINTAINS_DISTANCE | MONST_IMMUNE_TO_FIRE | MONST_FIERY), (MA_HIT_BURN)},

    // special effect monsters
    {0, "spectral blade", G_WEAPON, &spectralBladeColor, 1, 0, 150, {1, 1, 1}, 0, 50, 100, 0, SPECTRAL_BLADE_LIGHT, false, 0, 0, {0}, (MONST_INANIMATE | MONST_NEVER_SLEEPS | MONST_FLIES | MONST_WILL_NOT_USE_STAIRS | MONST_DIES_IF_NEGATED | MONST_IMMUNE_TO_WEBS | MONST_NOT_LISTED_IN_SIDEBAR)},
    {0, "spectral sword", G_WEAPON, &spectralImageColor, 1, 0, 150, {1, 1, 1}, 0, 50, 100, 0, SPECTRAL_IMAGE_LIGHT, false, 0, 0, {0}, (MONST_INANIMATE | MONST_NEVER_SLEEPS | MONST_FLIES | MONST_WILL_NOT_USE_STAIRS | MONST_DIES_IF_NEGATED | MONST_IMMUNE_TO_WEBS)},
    {0, "stone guardian", G_GUARDIAN, &white, 1000, 0, 200, {12, 17, 2}, 0, 100, 100, DF_RUBBLE, 0, false, 100, DF_GUARDIAN_STEP, {0}, (MONST_INANIMATE | MONST_NEVER_SLEEPS | MONST_ALWAYS_HUNTING | MONST_IMMUNE_TO_FIRE | MONST_IMMUNE_TO_WEAPONS | MONST_WILL_NOT_USE_STAIRS | MONST_DIES_IF_NEGATED | MONST_ALWAYS_USE_ABILITY | MONST_GETS_TURN_ON_ACTIVATION), (MA_REFLECT_100)},
    {0, "winged guardian", G_WINGED_GUARDIAN, &blue, 1000, 0, 200, {12, 17, 2}, 0, 100, 100, DF_RUBBLE, 0, false, 100, DF_SILENT_GLYPH_GLOW, {BOLT_BLINKING}, (MONST_INANIMATE | MONST_NEVER_SLEEPS | MONST_ALWAYS_HUNTING | MONST_IMMUNE_TO_FIRE | MONST_IMMUNE_TO_WEAPONS | MONST_WILL_NOT_USE_STAIRS | MONST_DIES_IF_NEGATED | MONST_GETS_TURN_ON_ACTIVATION | MONST_ALWAYS_USE_ABILITY), (MA_REFLECT_100)},
    {0, "guardian spirit", G_GUARDIAN, &spectralImageColor, 1000, 0, 200, {5, 12, 2}, 0, 100, 100, 0, SPECTRAL_IMAGE_LIGHT, false, 100, 0, {0}, (MONST_INANIMATE | MONST_NEVER_SLEEPS | MONST_IMMUNE_TO_FIRE | MONST_IMMUNE_TO_WEAPONS | MONST_DIES_IF_NEGATED | MONST_ALWAYS_USE_ABILITY), (MA_REFLECT_100)},
    {0, "Warden of Yendor", G_WARDEN, &yendorLightColor, 1000, 0, 300, {12, 17, 2}, 0, 200, 200, DF_RUBBLE, YENDOR_LIGHT, true, 100, 0, {0}, (MONST_NEVER_SLEEPS | MONST_ALWAYS_HUNTING | MONST_INVULNERABLE | MONST_NO_POLYMORPH)},
    {0, "eldritch totem", G_TOTEM, &glyphColor, 80, 0, 0, {0, 0, 0}, 0, 100, 100, DF_RUBBLE_BLOOD, 0, false, 0, 0, {0}, (MONST_IMMUNE_TO_WEBS | MONST_NEVER_SLEEPS | MONST_IMMOBILE | MONST_INANIMATE | MONST_ALWAYS_HUNTING | MONST_WILL_NOT_USE_STAIRS | MONST_GETS_TURN_ON_ACTIVATION | MONST_ALWAYS_USE_ABILITY), (MA_CAST_SUMMON)},
    {0, "mirrored totem", G_TOTEM, &beckonColor, 80, 0, 0, {0, 0, 0}, 0, 100, 100, DF_RUBBLE_BLOOD, 0, false, 100, DF_MIRROR_TOTEM_STEP, {BOLT_BECKONING}, (MONST_IMMUNE_TO_WEBS | MONST_NEVER_SLEEPS | MONST_IMMOBILE | MONST_INANIMATE | MONST_ALWAYS_HUNTING | MONST_WILL_NOT_USE_STAIRS | MONST_GETS_TURN_ON_ACTIVATION | MONST_ALWAYS_USE_ABILITY | MONST_IMMUNE_TO_WEAPONS | MONST_IMMUNE_TO_FIRE), (MA_REFLECT_100)},

    // legendary allies
    {0, "unicorn", G_UNICORN, &white, 40, 60, 175, {2, 10, 2}, 20, 50, 100, DF_RED_BLOOD, UNICORN_LIGHT, true, 1, DF_UNICORN_POOP, {BOLT_HEALING, BOLT_SHIELDING}, (MONST_MAINTAINS_DISTANCE | MONST_MALE | MONST_FEMALE), (0)},
    {0, "ifrit", G_IFRIT, &ifritColor, 40, 75, 175, {5, 13, 2}, 1, 50, 100, DF_ASH_BLOOD, IFRIT_LIGHT, true, 0, 0, {BOLT_DISCORD}, (MONST_IMMUNE_TO_FIRE | MONST_FLIES | MONST_MALE), (0)},
    {0, "phoenix", G_PHOENIX, &phoenixColor, 30, 70, 175, {4, 10, 2}, 0, 50, 100, DF_ASH_BLOOD, PHOENIX_LIGHT, true, 0, 0, {0}, (MONST_IMMUNE_TO_FIRE | MONST_FLIES | MONST_NO_POLYMORPH)},
    {0, "phoenix egg", G_EGG, &phoenixColor, 50, 0, 0, {0, 0, 0}, 0, 100, 150, DF_ASH_BLOOD, PHOENIX_EGG_LIGHT, false, 0, 0, {0}, (MONST_IMMUNE_TO_FIRE | MONST_IMMUNE_TO_WEBS | MONST_NEVER_SLEEPS | MONST_IMMOBILE | MONST_INANIMATE | MONST_WILL_NOT_USE_STAIRS | MONST_NO_POLYMORPH | MONST_ALWAYS_HUNTING | MONST_IMMUNE_TO_WEAPONS), (MA_CAST_SUMMON | MA_ENTER_SUMMONS)},
    {0, "mangrove dryad", G_ANCIENT_SPIRIT, &tanColor, 70, 60, 175, {2, 8, 2}, 6, 100, 100, DF_ASH_BLOOD, 0, true, 0, 0, {BOLT_ANCIENT_SPIRIT_VINES}, (MONST_IMMUNE_TO_WEBS | MONST_ALWAYS_USE_ABILITY | MONST_MAINTAINS_DISTANCE | MONST_NO_POLYMORPH | MONST_MALE | MONST_FEMALE), (0)},

    // monsties
    {0, "monstie", G_JACKAL, &jackalColor, 8, 0, 70, {2, 4, 1}, 20, 50, 100, DF_RED_BLOOD, 0, false, 1, DF_URINE, {0}},
