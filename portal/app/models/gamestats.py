...
class GameStats(BaseModel):
    ...
    Attributes:
        ...
        win_rate (Optional[float]): The player's win rate, calculated as games_won / games_played. Defaults to None.
        deepest_level (Optional[int]): The deepest level reached in any game. Defaults to None.
        cumulative_levels (Optional[int]): The total number of levels across all games. Defaults to None.
        ...
        cumulative_gold (Optional[int]): The cumulative gold collected across all games. Defaults to None.
        most_lumenstones (Optional[int]): The most lumenstones collected in a single game. Defaults to None.
        cumulative_lumenstones (Optional[int]): The cumulative number of lumenstones collected across all games. Defaults to None.
        fewest_turns_win (Optional[int]): The fewest number of turns taken to win a game. Defaults to None.
        cumulative_turns (Optional[int]): The total number of turns taken across all games. Defaults to None.
        longest_win_streak (Optional[int]): The longest consecutive win streak. Defaults to None.
        longest_mastery_streak (Optional[int]): The longest consecutive mastery streak. Defaults to None.
        current_win_streak (Optional[int]): The current consecutive win streak. Defaults to None.
        current_mastery_streak (Optional[int]): The current consecutive mastery streak. Defaults to None.
    """
    games_played: int = 0
    games_escaped: int = 0
